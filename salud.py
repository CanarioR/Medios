...
class ImageViewer(QGraphicsView):
    ...
    def create_fixed_text(self):
        ...
        self.content_edit.setGeometry(50, 100, 450, 550)  # Posición fija
    ...
    def adjust_text_position(self, value):
        ...
        self.title_edit.move(450, 220 - scroll_offset)
        self.content_edit.move(450, 270 - scroll_offset)
        self.reporter_edit.move(920, 420 - scroll_offset)
        self.capture_button.move(920, 270 - scroll_offset)
        self.photo_label.move(920, 220 - scroll_offset)
        self.second_image_label.move(920, 460 -scroll_offset)
    ...
    def draw_widgets_on_pdf(self, painter, img_width, img_height, page_width, page_height, img_pos, scroll_value):
        ...
        title_x_scaled = int((title_x - img_pos.x() - 300))  # Ajustar posición X
        title_y_scaled = int((title_y - img_pos.y() - scroll_value + 460))  # Ajustar posición Y
        ...
        content_x_scaled = int((content_x - img_pos.x() - 300))  # Ajustar posición X
        content_y_scaled = int((content_y - img_pos.y() - scroll_value + 580))  # Ajustar posición Y
        ...
        reporter_y_scaled = int((reporter_y - img_pos.y() - scroll_value + 920))  # Ajustar posición Y
        ...
        if self.second_image_label.pixmap():
            ...
            second_img_x_scaled = int((second_img_x - img_pos.x() + 700))  # Ajustar posición X
            second_img_y_scaled = int((second_img_y - img_pos.y() - scroll_value + 970))  # Ajustar posición Y
        ...
        if self.photo_label.pixmap():
            ...
            photo_x_scaled = int((photo_x - img_pos.x() + 700))  # Ajustar posición X
            photo_y_scaled = int((photo_y - img_pos.y() - scroll_value + 650))  # Ajustar posición Y
            photo_w_scaled = int(photo_w * 2.5)  # Ajustar ancho
            photo_h_scaled = int(photo_h * 2.2)  # Ajustar alto
...
if __name__ == "__main__":
    ...
    window = ImageViewer(ruta_recurso("backgrounds/Salud.png"))  # Cambia por la ruta real de tu imagen        
