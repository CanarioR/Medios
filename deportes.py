...
class ImageViewer(QGraphicsView):
    ...
    def create_fixed_text(self):
        ...
        self.content_edit.setGeometry(50, 100, 450, 500)  # Posición fija
        ...
        self.content_edit.textChanged.connect(lambda: self.limit_text(self.content_edit, 660))  # máximo 500 caracteres
    ...
    def adjust_text_position(self, value):
        ...
        self.title_edit.move(750, 350 - scroll_offset)
        self.content_edit.move(700, 400 - scroll_offset)
        self.reporter_edit.move(450, 550 - scroll_offset)
        self.capture_button.move(450, 400 - scroll_offset)
        self.photo_label.move(450, 350 - scroll_offset)
        self.second_image_label.move(1280, 400 -scroll_offset)
    ...
    def draw_widgets_on_pdf(self, painter, img_width, img_height, page_width, page_height, img_pos, scroll_value):
        ...
        title_x_scaled = int((title_x - img_pos.x() + 350))  # Ajustar posición X
        title_y_scaled = int((title_y - img_pos.y() - scroll_value + 690))  # Ajustar posición Y
        ...
        content_x_scaled = int((content_x - img_pos.x() + 250))  # Ajustar posición X
        content_y_scaled = int((content_y - img_pos.y() - scroll_value + 840))  # Ajustar posición Y
        ...
        reporter_x_scaled = int((reporter_x - img_pos.x() - 500))  # Ajustar posición X
        reporter_y_scaled = int((reporter_y - img_pos.y() - scroll_value + 1080))  # Ajustar posición Y
        ...
        if self.second_image_label.pixmap():
            ...
            second_img_x_scaled = int((second_img_x - img_pos.x() + 1320))  # Ajustar posición X
            second_img_y_scaled = int((second_img_y - img_pos.y() - scroll_value + 940))  # Ajustar posición Y
        ...
        if self.photo_label.pixmap():
            ...
            photo_y_scaled = int((photo_y - img_pos.y() - scroll_value + 700))  # Ajustar posición Y
            photo_w_scaled = int(photo_w * 2.8)  # Ajustar ancho
            photo_h_scaled = int(photo_h * 2.5)  # Ajustar alto
...
if __name__ == "__main__":
    ...
    window = ImageViewer(ruta_recurso("backgrounds/Deportes.png"))  # Cambia por la ruta real de tu imagen        
