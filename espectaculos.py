...
class ImageViewer(QGraphicsView):
    ...
    def create_fixed_text(self):
        ...
        self.content_edit.setGeometry(50, 100, 270, 900)  # Posición fija
    ...
    def adjust_text_position(self, value):
        ...
        self.title_edit.move(460, 220 - scroll_offset)
        self.content_edit.move(460, 270 - scroll_offset)
        self.reporter_edit.move(750, 470 - scroll_offset)
        self.capture_button.move(750, 320 - scroll_offset)
        self.photo_label.move(750, 270 - scroll_offset)
        self.second_image_label.move(750, 510 -scroll_offset)
    ...
    def draw_widgets_on_pdf(self, painter, img_width, img_height, page_width, page_height, img_pos, scroll_value):
        ...
        title_x_scaled = int((title_x - img_pos.x() - 380))  # Ajustar posición X
        title_y_scaled = int((title_y - img_pos.y() - scroll_value + 450))  # Ajustar posición Y
        ...
        content_x_scaled = int((content_x - img_pos.x() - 380))  # Ajustar posición X
        content_y_scaled = int((content_y - img_pos.y() - scroll_value + 550))  # Ajustar posición Y

        # Establecer la fuente para el contenido
        content_font = QFont("Times New Roman", 16)  # Tamaño de fuente para el contenido
        ...
        reporter_x_scaled = int((reporter_x - img_pos.x() + 150))  # Ajustar posición X
        reporter_y_scaled = int((reporter_y - img_pos.y() - scroll_value + 1060))  # Ajustar posición Y
        ...
        if self.second_image_label.pixmap():
            ...
            second_img_x_scaled = int((second_img_x - img_pos.x() + 340))  # Ajustar posición X
            second_img_y_scaled = int((second_img_y - img_pos.y() - scroll_value + 1110))  # Ajustar posición Y
            second_img_w_scaled = int(second_img_w * 2.5)  # Ajustar ancho
            second_img_h_scaled = int(second_img_h * 2.5)  # Ajustar alto
        ...
        if self.photo_label.pixmap():
            ...
            photo_x_scaled = int((photo_x - img_pos.x() + 350))  # Ajustar posición X
            photo_y_scaled = int((photo_y - img_pos.y() - scroll_value + 740))  # Ajustar posición Y
            photo_w_scaled = int(photo_w * 2.5)  # Ajustar ancho
            photo_h_scaled = int(photo_h * 2.3)  # Ajustar alto
...
if __name__ == "__main__":
    ...
    window = ImageViewer(ruta_recurso("backgrounds/Espectaculos.png"))  # Cambia por la ruta real de tu imagen        
